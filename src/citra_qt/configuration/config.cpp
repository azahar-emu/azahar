...
const std::array<UISettings::Shortcut, 41> QtConfig::default_hotkeys {{
     ...
     {QStringLiteral("Capture Screenshot"),       QStringLiteral("Main Window"), {QStringLiteral("Ctrl+P"), QStringLiteral(""),  Qt::WidgetWithChildrenShortcut}},
      {QStringLiteral("Debug Pause"),              QStringLiteral("Main Window"), {QStringLiteral("Ctrl+F4"), QStringLiteral(""),Qt::WidgetWithChildrenShortcut}},
     {QStringLiteral("Debug Resume"),             QStringLiteral("Main Window"), {QStringLiteral("Ctrl+F5"), QStringLiteral(""), Qt::WidgetWithChildrenShortcut}},
     {QStringLiteral("Debug Step"),               QStringLiteral("Main Window"), {QStringLiteral("Ctrl+F6"), QStringLiteral(""), Qt::WidgetWithChildrenShortcut}},
