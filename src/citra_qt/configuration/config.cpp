...
const std::array<UISettings::Shortcut, 43> QtConfig::default_hotkeys {{
     ...
     {QStringLiteral("Debug Unschedule All"),     QStringLiteral("Main Window"), {QStringLiteral(""),       Qt::ApplicationShortcut}},
     {QStringLiteral("Debug Schedule All"),       QStringLiteral("Main Window"), {QStringLiteral(""),       Qt::ApplicationShortcut}},
